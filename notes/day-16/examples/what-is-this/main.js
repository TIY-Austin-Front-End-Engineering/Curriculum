function User(firstName, lastName, password) {
	...
	this.isPasswordValid = function(guess) {
...
// 	firstName: 'Aaron',
// 	lastName: 'Larner',
// 	profession: 'Interpretive Dancer',
// 	password: 'NutellaIsGreat',
// 	info: whatIsThis,
// 	isPasswordValid: function(guess) {
// 		return this.password === guess;
// 	}
// };

// function isPasswordValid(realPassword, guess) {
// 	return realPassword === guess;
// }
