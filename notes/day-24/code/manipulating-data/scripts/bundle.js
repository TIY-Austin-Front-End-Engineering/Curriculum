...
var studentScores = [{ name: 'Andrea', score: 86 }, { name: 'Billy', score: 73 }, { name: 'Charles', score: 97 }, { name: 'David', score: 56 }, { name: 'Edward', score: 78 }, { name: 'Francis', score: 88 }, { name: 'Gabby', score: 90 }];

var products = [{ name: 'Motorola Moto X', category: 'Electronics', price: 329.99, sellerId: 1 }, { name: 'Suede Classic Sneaker', category: 'Shoes', price: 119.99, sellerId: 1 }, { name: 'Roma Basic Sneaker', category: 'Shoes', price: 145.00, sellerId: 1 }, { name: 'Lightning Cable', category: 'Electronics', price: 20.00, sellerId: 2 }, { name: 'Learning JavaScript Design Patterns', category: 'Books', price: 18.11, sellerId: 2 }, { name: 'GEL-Cumulus 16 Running Shoe', category: 'Shoes', price: 200.00, sellerId: 2 }, { name: 'Dual USB Car Phone Charger', category: 'Electronics', price: 7.0, sellerId: 3 }, { name: 'The Principles of Object-Oriented JavaScript', category: 'Books', price: 15.96, sellerId: 3 }, { name: 'JavaScript: The Good Parts', category: 'Books', price: 17.69, sellerId: 3 }, { name: 'USB Desktop Rapid Charger', category: 'Electronics', price: 30.00, sellerId: 3 }];

var sellers = [{ id: 1, name: 'Amazon', location: 'The Internet', rating: 4.5 }, { id: 2, name: 'Tech Armor', location: 'The Web', rating: 3.2 }, { id: 3, name: 'O\'Reiley', location: 'A Place', rating: 5 }];
